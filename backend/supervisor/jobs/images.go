...
var JobToImage = map[string]string{
	...
	"linear-create-comment":                  "supervisor-linear",
	"linear-create-project":                  "supervisor-linear",
