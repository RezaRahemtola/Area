...
def change_interface_language():
    args = get_arguments({"auth", "language", "workflowStepId", "identifier"})
    ...
    try:
        ...
        with grpc.insecure_channel(target) as channel:
            ...
            AreaBackServiceStub(channel).OnReaction(
                JobData(name="google-change-gmail-interface-language", identifier=args["identifier"], params=params))
